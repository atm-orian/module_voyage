 ...
 *				Such a file must be copied into htdocs/voyage/core/modules directory.
...
class modvoyage extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->description = "Description of module voyage";
		...
		// for specific path of parts (eg: /voyage/core/modules/barcode)
		// for specific css file (eg: /voyage/css/voyage.css.php)
		...
		//							'css' => array('/voyage/css/voyage.css.php'),	// Set this to relative path of css file if module has its own css file
	 	//							'js' => array('/voyage/js/voyage.js'),          // Set this to relative path of js file if module must load a js on all pages
		//							'hooks' => array('hookcontext1','hookcontext2'),  	// Set here all hooks context managed by module
		//							'dir' => array('output' => 'othermodulename'),      // To force the default directories names
		//							'workflow' => array('WORKFLOW_MODULE1_YOURACTIONTYPE_MODULE2'=>array('enabled'=>'! empty($conf->module1->enabled) && ! empty($conf->module2->enabled)', 'picto'=>'yourpicto@voyage')) // Set here all workflow context managed by module
		//                        );
		$this->module_parts = array();
		...
		$this->config_page_url = array("voyage_setup.php@voyage");
		...
		// Example:
		// $this->const=array(0=>array('VOYAGE_MYNEWCONST1','chaine','myvalue','This is a constant to add',1),
		//                             1=>array('VOYAGE_MYNEWCONST2','chaine','myvalue','This is another constant to add',0, 'current', 1)
		// );
		$this->const = array();

		// Array to add new pages in new tabs
		// Example: $this->tabs = array('objecttype:+tabname1:Title1:voyage@voyage:$user->rights->voyage->read:/voyage/mynewtab1.php?id=__ID__',  	// To add a new tab identified by code tabname1
        //                              'objecttype:+tabname2:Title2:voyage@voyage:$user->rights->othermodule->read:/voyage/mynewtab2.php?id=__ID__',  	// To add another new tab identified by code tabname2
...
/*
		$this->rights[$r][0] = $this->numero . $r;	// Permission id (must not be already used)
		$this->rights[$r][1] = 'voyage_read';	// Permission label
		$this->rights[$r][3] = 0; 					// Permission by default for new user (0/1)
		...
		$this->rights[$r][0] = $this->numero . $r;	// Permission id (must not be already used)
		$this->rights[$r][1] = 'voyage_write';	// Permission label
		$this->rights[$r][3] = 0; 					// Permission by default for new user (0/1)
		...
		$this->rights[$r][0] = $this->numero . $r;	// Permission id (must not be already used)
		$this->rights[$r][1] = 'voyage_delete';	// Permission label
		$this->rights[$r][3] = 0; 					// Permission by default for new user (0/1)
...
*/
		...
		$this->menu[$r]=array(	'fk_menu'=>'fk_mainmenu=voyage',		// Put 0 if this is a single top menu or keep fk_mainmenu to give an entry on left
									'type'=>'top',			                // This is a Top menu entry
									'titre'=>'Voyage',
									'mainmenu'=>'voyage',
									'leftmenu'=>'voyage_left',			// This is the name of left menu for the next entries
									'url'=>'/voyage/list.php',
		...
		// Example to declare a Left Menu entry into an existing Top menu entry:
		 $this->menu[$r]=array(	'fk_menu'=>'fk_mainmenu=voyage,fk_leftmenu=voyage_left',		    // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
									...
									'titre'=>'voyage left menu',
									'mainmenu'=>'voyage',
									'leftmenu'=>'voyage_left',			// Goes into left menu previously created by the mainmenu
...
/*
		...
		$this->menu[$r]=array(
			...
			'type'=>'left',			                // This is a Left menu entry
			'titre'=>$langs->trans('LeftMenuvoyageCreate'),
			'mainmenu'=>'voyage',
			'leftmenu'=>'voyage_left_create',
			'url'=>'/voyage/card.php?action=create',
			'langs'=>'voyage@voyage',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>100+$r,
...
*/
	...
	public function init($options = '')
	{
		...
		require dol_buildpath('/voyage/script/create-maj-base.php');

		$result=$this->_load_tables('/voyage/sql/');

		setEventMessage('voyageNewRightsDefinedCheckUserRights', 'warnings');
